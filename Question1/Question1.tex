...
\hypertarget{african-countries}{%
\section{\texorpdfstring{African countries
\label{African countries}}{African countries }}\label{african-countries}}
...
\caption{BRICS country differences \label{Figure1}}\label{fig:Figure1}
\end{figure}
...
\caption{African country differences \label{Figure2}}\label{fig:Figure2}
\end{figure}
...
\hypertarget{specific-insights-into-concentrated-groupings}{%
\section{Specific insights into concentrated
groupings}\label{specific-insights-into-concentrated-groupings}}
