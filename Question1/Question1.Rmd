...
```{r AfricavsBRICS, include=FALSE}
knitr::opts_chunk$set(echo = FALSE, message = FALSE, warning = FALSE, fig.width = 6, fig.height = 5, fig.pos="H", fig.pos = 'H')
BRICS_countries <- c("Brazil", "Russia", "India", "China", "South Africa")
BRICS <- owid_covid_data |> filter(owid_covid_data, location == BRICS_countries)
...
mergedtable = apply_labels()
pacman::p_load(tableHTML)
library(tableHTML)
names(fullmerge) <- c(' ', 'Mean', 'Mortality infected', 'Mortality population', 'Mean', 'Mortality infected', 'Mortality population','Mean', 'Mortality infected', 'Mortality population','Mean', 'Mortality infected', 'Mortality population','Mean', 'Mortality infected', 'Mortality population','Mean', 'Mortality infected', 'Mortality population')
tableHTML(fullmerge, 
          rownames = FALSE,
          second_header = list(c(1, 3, 3, 3, 3, 3, 3), c('', 'Life Expectancy', 'Female smokers', 'Male smokers', 'Elderly', 'Hospital beds', 'Handwashing')),
          widths = rep(50, 5),
          theme = 'scientific')
table <- function(data1=data1,data2=data2,data3=data3,data4=data4,data5=data5,data6=data6){
